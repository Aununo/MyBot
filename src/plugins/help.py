...
- /remind <事件> <时间> [日期] [--everyday | --everyNdays | 周几]
  ...
  » 群聊里也支持代别人建提醒：/remind @某人 吃药 23:30 --everyday
  » 若桥接已配置家庭角色，也可直接说“每天23:30提醒你妈妈吃药”这类自然话。
  » 支持日期格式: 明天、后天、N天后、YYYY-MM-DD、MM-DD
  » 支持周几格式: 周一~周日、星期一~星期日
- /notready <新时间>
  » (在收到提醒后使用) 将提醒推迟到当日指定时间。
  » 例: /notready 23:30
- /listreminders [@某人] (别名: /我的提醒)
  » 查看你当前设置的提醒；群聊里可带 @某人 查看对方的提醒。
  » 例: /我的提醒
  » 例: /我的提醒 @某人
- /cancelremind <事件> (别名: /取消提醒)
  » 取消一个指定的提醒；群聊里可带 @某人 取消对方那条提醒。
  » 例: /cancelremind 开会
  » 例: /取消提醒 @某人 吃药""",
...
- /todo play clear
  » 清除已完成的娱乐事项。""",
    ...
    "countdown": """⏰【倒计时插件】
管理你的重要事件时间差，既能看未来倒计时，也能看过去多久。
- /countdown add <事件名> <截止时间>
  » 添加一个事件时间。
  » 例: /countdown add 考试 2025-12-31 18:00
  » 支持格式: 2025-12-31、2025-12-31 23:59、2025/12/31 23:59:59
  » 也可以添加过去的日期，用来查看已经过去多久。
- /countdown <事件名>
  » 查看指定事件距离现在还有多久，或已经过去多久。
  » 例: /countdown 考试
- /countdown list (或直接 /countdown)
  » 查看所有事件的时间差。
- /countdown del <事件名>
  » 删除一个事件。
  » 例: /countdown del 考试
...
- /ping
  » 检测机器人响应时间。""",
    ...
    "latex": """✨【通用指令 - LaTeX】
- /latex <LaTeX代码>
  » 渲染 LaTeX 公式为图片，支持多行/环境及行内模式，默认带边框和留白。""",
